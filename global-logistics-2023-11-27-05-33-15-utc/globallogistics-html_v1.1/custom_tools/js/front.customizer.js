...
custom_options  +='<div id="custom_options" class="custom_options co_light co_show_reset">';
custom_options  +=    '<a href="#" id="co_toggle">';
custom_options  +=        '<span class="icon-cog"></span>';
custom_options  +=    '</a>';
custom_options  +=    '<div class="co_header">';
custom_options  +=        '<div class="co_title">';
custom_options  +=            '<span>Style switcher</span>';
custom_options  +=            '<a href="#" id="co_theme_reset" class="co_reset icon-arrows-cw" title="Reset to defaults">Reset</a>';
custom_options  +=        '</div>';
custom_options  +=    '</div>';
custom_options  +=    '<div id="sc_custom_scroll" class="co_options sc_scroll sc_scroll_vertical sc_custom_scroll swiper-free-mode">';
...
custom_options  +=                        '<div class="switcher" data-value="body_style_fullscreen"></div>';
custom_options  +=                        '<a href="#" data-value="body_style_boxed">Boxed</a>';
custom_options  +=                        '<a href="#" data-value="body_style_wide">Wide</a>';
custom_options  +=                        '<a href="#" data-value="body_style_fullscreen">Fullscreen</a>';
custom_options  +=                    '</div>';
custom_options  +=                '</div>';
custom_options  +=                '<div class="co_section">';
custom_options  +=                    '<div class="co_label">Custom Color</div>';
custom_options  +=                    '<div class="co_colorpic_list">';
custom_options  +=                        '<div class="iColorPicker" data-options="main_color" data-value="#eeba00">';
custom_options  +=                            '<span>Main color</span>';
custom_options  +=                        '</div>';
custom_options  +=                        '<div class="iColorPicker" data-options="accent_color" data-value="#5cb9e2">';
...
custom_options  +=            '</div>';
custom_options  +=        '</div>';
custom_options  +=        '<div id="sc_custom_scroll_bar" class="sc_scroll_bar sc_scroll_bar_vertical sc_custom_scroll_bar">';
custom_options  +=        '</div>';
custom_options  +=    '</div>';
custom_options  +='</div>';
